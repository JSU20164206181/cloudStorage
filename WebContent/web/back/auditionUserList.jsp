...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        ...
        <span class="r">共有数据：<strong>${totalNum}</strong> 条</span> </div>
    <div class="mt-20">
        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td class="td-manage">
                    <a title="审核发布" href="javascript:;" onclick="member_audition(this,${user.userId})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe603;</i></a>
        ...
        <div id="DataTables_Table_0_wrapper"
            ...
            <div class="dataTables_paginate paging_full_numbers" id="tablePage">
                <a class="paginate_button first disabled"
                   ...
                   id="firstPage" href="auditingUser.action?page=1">第一页</a> <a
                    class="paginate_button previous disabled"
                    aria-controls="DataTables_Table_0" data-dt-idx="1" tabindex="0"
                    id="previousPage" href="auditingUser.action?page=${page-1 }">上一页</a>
                ...
                <a class="paginate_button next disabled"
                   ...
                   id="nextPage" href="auditingUser.action?page=${page+1 }">下一页</a>
                <a class="paginate_button last disabled"
                   aria-controls="DataTables_Table_0" data-dt-idx="4" tabindex="0"
                   id="lastPage" href="auditingUser.action?page=${totalPage}">最后一页</a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    /*用户审核*/
    function member_audition(obj,id){
        layer.confirm('审核用户',{btn:['通过','不通过']},function(){
            $.ajax({
                type: 'POST',
                data:{
                    "userId":id
                },
                url: '${pageContext.request.contextPath}/auditingUser.action',
                success: function(data){
                    if(data=="success") {
                        $(obj).parents("tr").remove();
                        layer.msg('审核成功!', {icon: 1, offset: '40%', time: 1000});
                    }else {
