    ...
    <form action="" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                ...
                <div class="radio-box">
                    <input type="radio" id="sex-2" value="女" name="sex" value="女">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" value="" placeholder="请输入密码" id="userPassword" name="userPassword">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="password" class="input-text" value="" placeholder="请确认密码" id="userPassword1" name="userPassword1">
            </div>
        </div>
        <div class="row cl">
                ...
                $.ajax({
                   ...
                   url:'${pageContext.request.contextPath}/insertUser.action',
                    ...
                    success:function (data) {
                       console.log(data);
                       if(data=='success') {
                           layer.msg('添加成功!', {icon: 1, offset: '40%', time: 1000});
                           setTimeout(close, 1000);
                       }else {
                           layer.msg('添加失败!', {icon: 2, offset: '40%', time: 1000});
                           setTimeout(close, 1000);
                       }
                    }
                });
