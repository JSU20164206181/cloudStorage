...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 年龄区间统计 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    $(function () {
        $('#container').highcharts({
            ...
            series: [{
                ...
                name: '所占比例',
                data: [
                    ["儿童(1~6): ${ageCount.get('儿童')}人",   "${ageCount.get('儿童')}"/"${ageCount.get('all')}"],
